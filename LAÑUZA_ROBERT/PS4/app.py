...
def home():
    ...
    if request.method == 'POST':
        # Get form data
        given_name = request.form['first-name']  # Change the name to 'given_name'
        middle_initial = request.form['middle-initial']
        surname = request.form['last-name']  # Change the name to 'surname'
        dob = request.form['dob']  # Add date of birth
        home_address = request.form['address']  # Change the name to 'home_address'
        ...
        try:
            ...
            insert_query = '''
                INSERT INTO adet_user (given_name, middle_initial, surname, dob, email_address, home_address, password)
                VALUES (%s, %s, %s, %s, %s, %s, %s)
            '''
            cursor.execute(insert_query, (given_name, middle_initial, surname, dob, email_address, home_address, hashed_password))
